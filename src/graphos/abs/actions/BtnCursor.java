...
public class BtnCursor extends AbstractAction {

	public BtnCursor(String title, String iconPath, int mnemonic, String accelerator) {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		try {
			((DiagramGUI)MainFrame.getInstance().getRightPane().getSelectedFrame()).startSelectState();
		} catch (Exception e) {
